  ...
  <div class="wrapper">
    <div class="container main">
      <div class="row">
        ...
        <div class="col-md-4 right side-image">
...
export default {
  ...
  methods: {
    ...
    getWeatherClass() {
      if (!this.weather) {
        return ""; // Hava durumu bilgisi yoksa boş string döndür
      }
      const weather = this.weather.weather[0].main.toLowerCase();
      switch (weather) {
        case "clouds":
          return "cloudy"; // Bulutlu hava durumu için "cloudy" sınıfı döndür
        case "rain":
          return "rainy"; // Yağmurlu veya çiseli hava durumu için "rainy" sınıfı döndür
        case "drizzle":
          return "rainy"; // Yağmurlu veya çiseli hava durumu için "rainy" sınıfı döndür
        case "clear":
          return "clear"; // Karlı hava durumu için "clear" sınıfı döndür
        case "snowy":
          return "snowy"; // Karlı hava durumu için "clear" sınıfı döndür
        default:
          return ""; // Diğer hava durumları için boş string döndür
      }
    },
  },
};
